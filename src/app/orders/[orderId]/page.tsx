        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl font-bold">
              {t("Your produce is being packed")}
            </h1>
          </div>
          <Badge tone="emerald">CONFIRMED</Badge>
        </div>
        <div className="mt-7 grid gap-5 md:grid-cols-[1fr_.85fr]">
          <Card className="p-5">
            <OrderTracker current={2} />
          </Card>
          <div className="space-y-5">
            <Card className="overflow-hidden">
              <div className="h-24 bg-emerald-950 p-4 text-stone-50">
            ...
            <Card className="p-4">
              ...
              <p className="mt-4 font-mono text-xs text-slate-500">
                {t("Route shown is an estimate, not live GPS.")}
              </p>
            </Card>
          </div>
        </div>
